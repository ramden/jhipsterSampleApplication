package de.ramden.application.repository;

import de.ramden.application.JhipsterSampleApplicationApp;
import de.ramden.application.config.Constants;
import de.ramden.application.config.audit.AuditEventConverter;
import de.ramden.application.domain.PersistentAuditEvent;
...
import static de.ramden.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
